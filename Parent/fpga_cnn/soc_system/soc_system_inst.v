	soc_system u0 (
		...
		.cnn_result_pio_external_connection_export             (<connected-to-cnn_result_pio_external_connection_export>),             //             cnn_result_pio_external_connection.export
		.cnn_start_pio_external_connection_export              (<connected-to-cnn_start_pio_external_connection_export>),              //              cnn_start_pio_external_connection.export
		...
		.snapshot_addr_pio_external_connection_export          (<connected-to-snapshot_addr_pio_external_connection_export>),          //          snapshot_addr_pio_external_connection.export
		.snapshot_data_pio_external_connection_export          (<connected-to-snapshot_data_pio_external_connection_export>),          //          snapshot_data_pio_external_connection.export
		.camera_capture_trigger_pio_external_connection_export (<connected-to-camera_capture_trigger_pio_external_connection_export>), // camera_capture_trigger_pio_external_connection.export
		.img_wr_addr_pio_external_connection_export            (<connected-to-img_wr_addr_pio_external_connection_export>),            //            img_wr_addr_pio_external_connection.export
		.img_wr_data_pio_external_connection_export            (<connected-to-img_wr_data_pio_external_connection_export>),            //            img_wr_data_pio_external_connection.export
		.img_wr_ctrl_pio_external_connection_export            (<connected-to-img_wr_ctrl_pio_external_connection_export>)             //            img_wr_ctrl_pio_external_connection.export
	);
