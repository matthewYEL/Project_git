...
(
    ...
    localparam PAD8 = log2ceil(64'h10060 - 64'h10040); 
    ...
    // ( 0x70 .. 0x80 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 17'h70  && read_transaction  ) begin
            src_channel = 11'b00000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x10040 .. 0x10060 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 17'h10040   ) begin
    ...
    // ( 0x100c0 .. 0x100d0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 17'h100c0   ) begin
